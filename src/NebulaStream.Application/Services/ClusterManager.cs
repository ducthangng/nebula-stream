...
using NebulaStream.DTOs;

public class ClusterManager
{
    private readonly IAwsEksOrchestrator _eksOrchestrator;
    private readonly IClusterRepository _repository;

    private readonly ILogger<ClusterManager> _logger;

    public ClusterManager(
        IAwsEksOrchestrator _eksOrchestrator,
    ...
    /// <returns></returns>
    public async Task<ClusterResponse> CreateAndRegisterClusterAsync(ClusterConfig config)
    {
