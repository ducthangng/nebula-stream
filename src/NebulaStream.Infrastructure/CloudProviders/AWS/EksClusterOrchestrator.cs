...
namespace NebulaStream.Infrastructure.CloudProviders.AWS
{
    public class EksClusterOrchestrator : IKubernetesOrchestration
    {
        ...
        Task<ClusterResponse> IKubernetesOrchestration.CreateClusterAsync(Cluster clusterConfig)
        {
        ...
        Task<ClusterStatus> IKubernetesOrchestration.GetStatusAsync(string clusterId)
        {
            throw new NotImplementedException();
        }
